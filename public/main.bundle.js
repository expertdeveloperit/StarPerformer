...
var SpProfileComponent = (function () {
    ...
    SpProfileComponent.prototype.ngOnInit = function () {
        ...
        this.sharedService.getProfile().subscribe(function (data) {
            _this.profileresponce = data.data.user_info.profileUrl;
            ...
            if (_this.profileresponce) {
                _this.profile_image = _this.profileresponce;
            }
    ...
    SpProfileComponent.prototype.oncertifications = function (cer) {
        var _this = this;
        this.loginerror = "";
        if ((this.from_year && this.to_year) || (this.from_year && cer['present'])) {
            cer['from_year'] = this.from_year;
            cer['to_year'] = this.to_year;
            if (this.actionType) {
    ...
    SpProfileComponent.prototype.updatecertifications = function (updatecertificateList, i) {
        ...
        this.from_year = { date: { year: updatecertificateList.begin_year, month: updatecertificateList.begin_month, day: 1 } };
        if (updatecertificateList.end_year && updatecertificateList.end_month) {
            this.to_year = { date: { year: updatecertificateList.end_year, month: updatecertificateList.end_month, day: 1 } };
        }
        else {
            this.to_year = { date: { year: 2017, month: 1, day: 1 } };
        }
