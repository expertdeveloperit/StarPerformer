        ...
        if (result) {
            ...
            settingModel.findOne({
                ...
                if (record) {
                    ...
                    setting_data.country = req.body.country;
...
exports.certification = function(req, res) {
    ...
    userModel.findOne({
        ...
        if (result) {
            ...
            newdata.user_id = id;
            newdata.education_level = req.body.education_level;
            newdata.school = req.body.school;
            newdata.specialization = req.body.specialization;
            newdata.begin_year = req.body.eductionYear.date['year'];
            newdata.begin_month = req.body.eductionYear.date['month'];
            if(req.body.present){
                newdata.present = req.body.present;
            }
            else{
                newdata.end_month = req.body.toEduction.date['month'];
                newdata.end_year = req.body.toEduction.date['year'];
                newdata.present = false;
            }
            newdata.certificate_num = req.body.certificate_num;
            newdata.certification_type = req.body.certification_type;
